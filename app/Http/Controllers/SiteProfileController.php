...
class SiteProfileController extends Controller
{
    ...
    public function siteProfileUpdate(Request $request){
        ...
        if(isset($SiteProfile->id)){
            ...
            $SiteProfile->PaivacyPolicy =$request->PaivacyPolicy;
            $SiteProfile->TermsCondition =$request->TermsCondition;
            $SiteProfile->RetunRefundPolicy =$request->RetunRefundPolicy;
            $SiteProfile->shipping =$request->shipping;
            $SiteProfile->vat =$request->vat;
            $SiteProfile->save();
