                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="border: 1px solid #586bde;"  type="text" class="form-control{{$errors->has('EnventsName') ? ' is-invalid' : ''}}" value="{{old('EnventsName')}}" name="EnventsName" id="EnventsName">
                                        </div>

                                        <div class="form-group">
                                            <label for="EventsDate">Events Date:</label>
                                            <input style="border: 1px solid #586bde;"  type="date" class="form-control{{$errors->has('EventsDate') ? ' is-invalid' : ''}}" value="{{old('EventsDate')}}" name="EventsDate" id="EventsDate">
                                        </div>

                                        <div class="form-group">
                                            <label for="EventsTime">Events Time:</label>
                                            <input style="border: 1px solid #586bde;"  type="time" class="form-control{{$errors->has('EventsTime') ? ' is-invalid' : ''}}" value="{{old('EventsTime')}}" name="EventsTime" id="EventsTime">
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="FeaturedDetails">Events Short Details:</label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control" rows="7" placeholder="Enter Events Details" name="EventsDetails" id="EventsDetails">{{old('EventsDetails')}}</textarea>
                                        </div>
                                    </div>
                                </div>
