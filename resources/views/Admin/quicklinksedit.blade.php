        ...
        <section id="app" style="margin-top: 10px;" class="content">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    @endif
                    <div class="card">
                        <div class="card-header">Site Quick links</div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-7">
                                    <form action="{{url('admin/update-quicklinks',[$QuickLink->id])}}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label for="name">Quick Links Name</label>
                                            <input type="text" class="form-control{{$errors->has('name') ? ' is-invalid' : ''}}" value="{{$QuickLink->name}}" id="name"  name="name" placeholder="Enter Quick Links Name">
                                        </div>
                                        <div class="form-group">
                                            <label for="url">Link URL</label>
                                            <input type="text" class="form-control{{$errors->has('url') ? ' is-invalid' : ''}}" value="{{$QuickLink->url}}" id="url" name="url" placeholder="Enter Links URL">
                                        </div>
