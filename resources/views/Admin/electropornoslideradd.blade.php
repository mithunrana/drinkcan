                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="border: 1px solid #586bde;" type="text" class="form-control{{$errors->has('slidername') ? ' is-invalid' : ''}}" value="{{old('slidername')}}" placeholder="Enter slider name" name="slidername" id="slidername">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
