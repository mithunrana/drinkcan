        ...
        <section id="app" style="margin-top: 10px;" class="content">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    @endif
                    <div class="card">
                        <div class="card-header">FAQ Manage</div>
                        <div class="card-body">
                            <div class="row">
                                <div id="app" class="col-sm-6">
                                    <form action="{{url('admin/store-product-faq')}}" method="POST">
                                        @csrf
                                        <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control{{$errors->has('Question') ? ' is-invalid' : ''}}" value="{{old('Question')}}" id="Question"  name="Question" placeholder="Enter Question">
                                        </div>
                                        <div class="form-group">
                                            <label for="Content">Answer</label>
                                            <textarea type="text" rows="7" class="form-control{{$errors->has('Answer') ? ' is-invalid' : ''}}"  id="Answer" name="Answer" placeholder="Enter Answer Details....">{{old('Answer')}}</textarea>
                                        </div>
