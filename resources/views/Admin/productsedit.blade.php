                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div style="margin-top: 10px;" class="form-group">
                                            ...
                                            <input style="border: 1px solid #586bde;" type="text" name="Stock" placeholder="Enter Stock Quantity" class="form-control{{$errors->has('Stock') ? ' is-invalid' : ''}}" value="{{$Products->Stock}}" id="Stock">
                                        </div>
                                        <div style="margin-top: 10px;" class="form-group">
