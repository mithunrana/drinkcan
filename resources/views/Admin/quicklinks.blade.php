                                ...
                                <div class="col-sm-7">
                                    <form action="{{url('admin/quicklinks')}}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control{{$errors->has('name') ? ' is-invalid' : ''}}" value="{{old('name')}}" id="name"  name="name" placeholder="Enter Quick Links Name">
                                        </div>
                                        <div class="form-group">
                                            <label for="url">Link URL</label>
                                            <input type="text" class="form-control{{$errors->has('url') ? ' is-invalid' : ''}}" value="{{old('url')}}" id="url" name="url" placeholder="Enter Links URL">
                                        </div>
