                            ...
                            <form action="{{url('admin/siteprofile-update')}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input style="border: 1px solid #586bde;" type="text" class="form-control" placeholder="vat" @isset($SiteProfile->vat) value="{{$SiteProfile->vat}}" @endisset name="vat" id="vat">
                                    </div>

                                    <div class="form-group col-sm-6">
                                        <label for="shipping">Shipping Charge:</label>
                                        <input style="border: 1px solid #586bde;" type="text" class="form-control" placeholder="Enter Shipping Charge" @isset($SiteProfile->shipping) value="{{$SiteProfile->shipping}}" @endisset name="shipping" id="shipping">
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="PaivacyPolicy">Privacy Policy:</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control" rows="7" placeholder="Enter Privacy Policy Details" id="PaivacyPolicy" name="PaivacyPolicy" >@isset($SiteProfile->PaivacyPolicy){{$SiteProfile->PaivacyPolicy}}@endisset</textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="TermsCondition">Terms & Condition:</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control" rows="7" placeholder="Enter Site Terms & Condition" id="TermsCondition" name="TermsCondition" >@isset($SiteProfile->TermsCondition){{$SiteProfile->TermsCondition}}@endisset</textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="RetunRefundPolicy">Return & Refund Policy:</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control" rows="7" placeholder="Enter Retun & Refund Policy" id="RetunRefundPolicy" name="RetunRefundPolicy" >@isset($SiteProfile->RetunRefundPolicy){{$SiteProfile->RetunRefundPolicy}}@endisset</textarea>
                                        </div>
                                    </div>
                                </div>
