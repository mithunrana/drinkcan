            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{url('admin/news-store')}}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="border: 1px solid #586bde;"  type="text" class="form-control{{$errors->has('NewsName') ? ' is-invalid' : ''}}" value="{{old('NewsName')}}" name="NewsName" id="NewsName">
                                        </div>
