                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                <h3>Orders</h3>
                                <h4 style="color:white"> @php $Total =  \App\Order::get();  $active = \App\Order::Where('orderstatus','1')->get(); $Deactive = \App\Order::Where('orderstatus','2')->get(); echo 'Total: '.count($Total); echo ' Confirm: '.count($active); @endphp </h4>
                                <h4 style="color:#001c4e">{{ 'Pending: '.count($Deactive)}}</h4>
                            </div>
                            <div class="icon">
