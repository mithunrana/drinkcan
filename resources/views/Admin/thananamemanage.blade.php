        ...
        <section id="app" style="margin-top: 10px;" class="content">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    @endif
                    <div class="card">
                        <div class="card-header">Thana Name Manage</div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-7">
                                    <form action="{{url('admin/thana-name-store')}}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control{{$errors->has('Name') ? ' is-invalid' : ''}}" value="{{old('Name')}}" id="Name"  name="Name" placeholder="Enter Thana Name" required>
                                        </div>
