    ...
    <div class="content-wrapper">
        ...
        <section style="margin-top: 10px;" id="app" class="content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">News Edit Here</div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="border: 1px solid #586bde;" type="text" class="form-control{{$errors->has('BrowserTitle') ? ' is-invalid' : ''}}" value="{{$News->BrowserTitle}}" name="BrowserTitle" id="BrowserTitle">
                                        </div>

                                        <div class="form-group">
                                            <label for="Permalink">Permalink :</label>
                                            <input style="border: 1px solid #586bde;" oninput="this.value=this.value.toLowerCase()" type="text" class="form-control{{$errors->has('Permalink') ? ' is-invalid' : ''}}" value="{{$News->Permalink}}" name="Permalink" id="Permalink">
                                        </div>

                                        <div class="form-group">
                                            <label for="NewsName">News Name:</label>
                                            <input style="border: 1px solid #586bde;"  type="text" class="form-control{{$errors->has('NewsName') ? ' is-invalid' : ''}}" value="{{$News->NewsName}}" name="NewsName" id="NewsName">
                                        </div>

                                        <div class="form-group">
                                            <label for="SeoKeyword">SEO Keyword:</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control{{$errors->has('SeoKeyword') ? ' is-invalid' : ''}}" name="SeoKeyword" id="SeoKeyword">{{$News->SeoKeyword}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="SeoDescription">SEO Description:</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control{{$errors->has('SeoDescription') ? ' is-invalid' : ''}}"  name="SeoDescription" id="SeoDescription">{{$News->SeoDescription}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="FeaturedDetails">News Featured Details:</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control" rows="7" placeholder="Enter Service Structured Data" name="FeaturedDetails" id="FeaturedDetails">{{$News->FeaturedDetails}}</textarea>
                                        </div>
                                    </div>

                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="ProjectDetails">News Details:</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control" rows="7" placeholder="Enter Service Structured Data" name="ProjectDetails" id="ProjectDetails">{{$News->ProjectDetails}}</textarea>
                                        </div>
                                    </div>
                                </div>
