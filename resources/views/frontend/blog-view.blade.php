...
<section class="water-news clearfix " style="padding-bottom: 30px;">
    ...
    <div style="background: #deeff7;" class="water-helth-txt text-center py-3">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1 style="font-size: 21px;">{{$Blog->BlogName}}</h1>
    ...
    <div style="margin-top: 10px;" class="container">
        <div class="row">
            <div class="col-sm-8">
                <img src="{{asset('')}}{{$Blog->featuredimage->imageurl}}" alt="{{$Blog->ImageAltText}}" class="img-fluid">
            ...
            <div class="col-sm-4">
                <div class="row">
                    @foreach($RelatedBlog as $EachBlog)
                        <div class="col-sm-12">
                            <div style="margin-top: 5px;margin-bottom: 5px;border: 1px solid #0049bc;" class="news-box">
                                <a href="{{asset('')}}news/{{$EachBlog->Permalink}}">
                                    <img src="{{asset('')}}{{$EachBlog->featuredimage->imageurl}}" alt="{{$EachBlog->ImageAltText}}">
                                </a>
                                <div class="news-title">
                                    <h4 style="font-size: 18px;padding: 5px;">
                                        <a style="color:#0049bc" href="{{asset('')}}news/{{$EachBlog->Permalink}}">
                                            {{$EachBlog->BlogName}}
                                        </a>
                                    </h4>
                                </div>
