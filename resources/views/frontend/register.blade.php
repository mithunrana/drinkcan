...
@php
    $title = "Registration | Drinkcan India";
    $keywords =  "drinkcan, India, Registration, user login, sign up, user signup, how to register drinkcan India";
    $description =  "Registration drinkcan India official website get more information about water purifier in India. and get all kinds of update notification";
@endphp
